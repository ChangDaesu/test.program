...
while($data = mysql_fetch_assoc($result)){
  ...
  echo "<h3><td>{$data['title']}</td><h3><br>";
  echo "<td>{$data['place']}</td><br>";
  echo "<td>{$data['yosan']}</td><br>";
  echo "<td>{$data['gowith']}</td><br>";
...
<?php
  ...
  echo "<td>{$data['text']}</td><br>";
  echo "<img src='http://a1.zeroprm.com/b31_c296/asovip/img/article/{$data['image']}'><br>";
  echo "<td>{$data['hyouka']}</td><br>";
