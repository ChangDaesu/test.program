...
<html lang="ja">
  ...
  <body>
    <div id="bodyWrapper">
      ...
      <div id="header">
        <div id="inner">
          <p>最近、遊んでる？<br><span>大学生向けアソビ投稿サイト、asovip!</span><p>

              <?php if ($user): ?>
                <a href="post.php"><img id="headerBtn" src="img/btn_post.png" width="250px"></a>

              <?php else: ?>
                <a href="<?php echo $loginUrl; ?>"><img id="headerBtn" src="img/btn.png" width="250px"></a>
              <?php endif ?>
...
<!--         <div id="section1" class="row section">
          <div class="col-md-4 col-sm-4 col-xs-12">
            <img src="img/logo.png" alt="AGESTOCK BASEBALL CLUB" class="img-responsive">
            <h3 class="text-center">アソビを発見する</h3>
          </div>

          <div class="col-md-4 col-sm-4 col-xs-12">
            <img src="img/logo.png" alt="AGESTOCK BASEBALL CLUB" class="img-responsive">
            <h3 class="text-center">アソビを投稿する</h3>
          </div>

          <div class="col-md-4 col-sm-4 col-xs-12">
            <img src="img/logo.png" alt="AGESTOCK BASEBALL CLUB" class="img-responsive">
            <h3 class="text-center">アソビに誘う</h3>
          </div>
        </div> -->

        <div id="section2" class="row section">
          <h2><span></span>新着のアソビ</h2>
              ...
              $sql = "SELECT * FROM `asovip_article_tbl` order by postdate desc limit 4";
              ...
              <div class="col-md-3 col-sm-3 col-xs-12">
                  <div class="new_article">
                    <tr>
                      ...
                      <td>アソビ：<b><?php echo $kekka['title']; ?></b></td><br>
                      ...
                      <td>カテゴリ：
    <?php if ($kekka['select_1'] == 1) { ?>
        <HTML>アウトドア</HTML>
    <?php } ?>

    <?php if ($kekka['select_2'] == 1) { ?>
        <HTML>インドア</HTML>
    <?php } ?>

    <?php if ($kekka['select_3'] == 1) { ?>
        <HTML>朝に遊ぶ</HTML>
    <?php } ?>

    <?php if ($kekka['select_4'] == 1) { ?>
        <HTML>昼に遊ぶ</HTML>
    <?php } ?>

     <?php if ($kekka['select_5'] == 1) { ?>
        <HTML>夜に遊ぶ</HTML>
    <?php } ?>

    <?php if ($kekka['select_6'] == 1) { ?>
        <HTML>朝まで楽しむ</HTML>
    <?php } ?>

    <?php if ($kekka['select_7'] == 1) { ?>
        <HTML>騒いで楽しむ</HTML>
    <?php } ?>

    <?php if ($kekka['select_8'] == 1) { ?>
        <HTML>静かに楽しむ</HTML>
    <?php } ?></td><br>
...
<!--           <div class="col-md-3 col-sm-3 col-xs-12">
          ...
          <a class="text-right" href="zenbu.php">すべての投稿を見る</a>
        </div>
      ...
      <div id="orange">
        ...
        <div id="section4" class="row section">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
              <label for="inputtext" class="col-sm-3 control-label">ご質問内容</label>
              <div class="col-sm-9">
