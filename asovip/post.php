    ...
    <div id="bodyWrapper">
      ...
      <div class="container">
        ...
        <div id="section2" class="row section">
          ...
          <form action="post_send.php" method="POST" enctype="multipart/form-data">


            <br><b>タイトル</b><br>
            何をしたか一言で教えてください。（例；ラウンドワンお台場店でカラオケ）<br>
              <input type="text" name="title">
            <br>
            ...
            <option value="おひとり様">おひとり様</option>
            <option value="その他">その他</option>

            </select><br>

            <b>シーン</b><br>
              <input type="checkbox" name="select_1" value="1">アウトドア
              <input type="checkbox" name="select_2" value="1">インドア<br>
              <input type="checkbox" name="select_3" value="1">朝に遊ぶ
              <input type="checkbox" name="select_4" value="1">昼に遊ぶ
              <input type="checkbox" name="select_5" value="1">夜に遊ぶ
              <input type="checkbox" name="select_6" value="1">朝まで楽しむ<br>
              <input type="checkbox" name="select_7" value="1">騒いで楽しむ
              <input type="checkbox" name="select_8" value="1">静かに楽しむ


            <br>
                <br><b>本文</b><br>
                <textarea name="detail" cols="50" rows="7"></textarea>
                <br>
                

            <b>画像を添付する</b><br><input type="file" name="upfile">
             <br>
